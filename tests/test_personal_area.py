...
class TestPersonalArea:
    ...
    def test_transfer_to_personal_area_by_click(self, personal_area_page):
        login_page = PersonalAreaPage(personal_area_page)
    ...
    def test_transfer_to_order_history(self, personal_area_page):
        login_page = PersonalAreaPage(personal_area_page)
        login_page.click_personal_area_button()
    ...
    def test_exit_button(self, personal_area_page):
        login_page = PersonalAreaPage(personal_area_page)
        login_page.click_personal_area_button()
    ...
    def test_login_user_can_make_order(self, personal_area_page):
        login_page = PersonalAreaPage(personal_area_page)
